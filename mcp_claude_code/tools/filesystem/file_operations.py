...
class FileOperations:
    ...
    def register_tools(self, mcp_server: FastMCP) -> None:
        ...
        async def search_files(
            path: str, pattern: str, exclude_patterns: list[str], ctx: MCPContext
        ) -> str:
            ...
            try:
                ...
                exclusion_patterns = [pattern.lower() for pattern in exclude_patterns]
                ...
                async def search_recursive(current_path: Path) -> None:
                    ...
                    try:
                        for entry in current_path.iterdir():
                            ...
                            if is_excluded(
                                entry
                            ) or not self.permission_manager.is_path_allowed(
                                str(entry)
                            ):
                                continue
