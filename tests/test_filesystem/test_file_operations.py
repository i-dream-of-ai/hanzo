...
class TestFileOperations:
    ...
    @pytest.mark.asyncio
    async def test_read_file_allowed(self, file_operations, setup_allowed_path, test_file, mcp_context):
    ...
    async def test_write_file(self, file_operations, setup_allowed_path, mcp_context):
        ...
        file_operations.permission_manager.is_operation_approved = MagicMock(return_value=True)
    ...
    @pytest.mark.asyncio
    async def test_edit_file(self, file_operations, setup_allowed_path, test_file, mcp_context):
        """Test editing a file."""
        # Set up edits
        edits = [
            {"oldText": "This is a test file content.", "newText": "This is modified content."}
        ]
    ...
    @pytest.mark.asyncio
    async def test_create_directory(self, file_operations, setup_allowed_path, mcp_context):
    ...
    @pytest.mark.asyncio
    async def test_list_directory(self, file_operations, setup_allowed_path, mcp_context):
