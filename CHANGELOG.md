...
### Added
- Direct specification of external MCP servers via `--mcp` command-line option
- Improved documentation for external server management

## [0.1.28] - 2025-03-25

### Added
- Server registry with global repository of MCP servers
- Server management UI for enabling and disabling MCP servers
- Command-line interface for managing MCP servers
- Easy installation of new MCP servers like Neovim and iTerm2
...
### Added
- LLM-agnostic thinking mode with support for multiple providers (Hanzo, OpenAI, Anthropic)
- Priority-based fallback between LLM providers
- Environment variable configuration for enhanced thinking
- CLI arguments for LLM provider selection

## [0.1.25] - 2025-03-25

### Changed
- Increased command execution timeout from 60 seconds to 10 minutes (600 seconds)
- Updated all script execution timeouts to 10 minutes
- Updated project analysis timeouts to 10 minutes

### Improved
- Enhanced documentation in LLM.md with detailed component information and best practices
