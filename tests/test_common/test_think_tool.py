...
class TestThinkingTool:
    ...
    @pytest.mark.asyncio
    async def test_valid_thought(self, think_tool: ThinkingTool, mcp_context: MagicMock):
    ...
    @pytest.mark.asyncio
    async def test_empty_thought(self, think_tool: ThinkingTool, mcp_context: MagicMock):
